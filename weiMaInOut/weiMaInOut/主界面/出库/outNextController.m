...
@implementation outNextController
...
- (void)customUI
{
    ...
    UILabel *piciLabel = [[UILabel alloc] initWithFrame:CGRectMake(wuliumaLabel.right, 0, (thirdImageView.width - 10)/2.0, 50)];
    piciLabel.text =  @"客户编号";
    piciLabel.textAlignment = NSTextAlignmentCenter;
    [thirdImageView addSubview:piciLabel];
    
//    UILabel *chanpinLabel = [[UILabel alloc] initWithFrame:CGRectMake(piciLabel.right, 0, (thirdImageView.width - 10)/3.0-15, 50)];
