...
//            let vc = mainStoryboard.instantiateViewController(withIdentifier: "detail") as! HistoryDetailViewController
//            vc.result = item.result
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(">>>>>>>" + String(item.result.count))
//        cell.textLabel!.textAlignment = NSTextAlignment.center
        cell.textLabel?.text = "产品溯源码：" + item.result
        cell.detailTextLabel?.text = "扫码时间>>" + item.time
