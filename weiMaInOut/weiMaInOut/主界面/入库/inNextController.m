...
@implementation inNextController
...
//    UILabel *piciLabel = [[UILabel alloc] initWithFrame:CGRectMake(wuliumaLabel.right, 0, (thirdImageView.width - 10)/3.0-15, 50)];
//    piciLabel.text =  @"批次";
//    piciLabel.textAlignment = NSTextAlignmentCenter;
//    [thirdImageView addSubview:piciLabel];
    
    UILabel *chanpinLabel = [[UILabel alloc] initWithFrame:CGRectMake(wuliumaLabel.right, 0, (thirdImageView.width - 10)/2.0, 50)];
    chanpinLabel.text =  @"产品编号";
    chanpinLabel.textAlignment = NSTextAlignmentCenter;
    [thirdImageView addSubview:chanpinLabel];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.rightLabel.text = _goodsCode;
//    cell.label3.text = _goodsCode;
